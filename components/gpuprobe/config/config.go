...
func (c *GpuProbeUserConfig) GetQueryInterval() common.Duration {
	return c.GpuProbe.QueryInterval
}

func (c *GpuProbeUserConfig) SetQueryInterval(newInterval common.Duration) {
	c.GpuProbe.QueryInterval = newInterval
}
