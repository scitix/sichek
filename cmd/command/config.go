	...
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			cfg := map[string]string{
				...
				"scheduler":             ask(reader, v, "scheduler", "k8s scheduler[si-scheduler, default-scheduler]", ""),
				"pytorchjob_host_dir":   ask(reader, v, "pytorchjob_host_dir", "pytorchjob host directory to mount", ""),
				"roce_shared_mode":      ask(reader, v, "roce_shared_mode", "roce shared mode[none, macvlan, volcengine, lingjun]", "none"),
